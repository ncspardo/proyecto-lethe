...
fig.suptitle('Distribución de Amplitud EEG por Fase del Sueño - Healthy', fontsize=16)
...
for i, (idx, row) in enumerate(df.iterrows()):
    ...
    ax.hist(señal, bins=50, color='blue', alpha=0.7)  # 'bins' controla el número de barras
